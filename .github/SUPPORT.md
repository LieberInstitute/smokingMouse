# Getting help with `smokingMouse`

Thank you for using `smokingMouse`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/smokingMouse`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/smokingMouse),
...
[search issues and pull requests](https://github.com/LieberInstitute/smokingMouse/issues)
